    ...
    internal class ConsoleApp
    {
        ...
        bool ReadAll(out double[] values)
        {
            ...
            if (flag)
            {
                ...
                if (!double.TryParse(strArray[3].Trim(), out values[0])) { values[0] = 0; }
                if (!double.TryParse(strArray[0].Trim(), out values[1])) { values[1] = 0; }
                if (!double.TryParse(strArray[4].Trim(), out values[2])) { values[2] = 0; }
                if (!double.TryParse(strArray[1].Trim(), out values[3])) { values[3] = 0; }
                if (!double.TryParse(strArray[2].Trim(), out values[4])) { values[4] = 0; }
                if (!double.TryParse(strArray[5].Trim(), out values[5])) { values[5] = 0; }
                if (!double.TryParse(strArray[6].Trim(), out values[6])) { values[6] = 0; }
            }
